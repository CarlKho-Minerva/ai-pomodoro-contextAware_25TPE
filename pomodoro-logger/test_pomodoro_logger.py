#!/usr/bin/env python3
"""
Pomodoro Work Journal Logger - Test Version (60 seconds)
A 60-second test session logger that captures keystrokes, clipboard changes, and window activity.
"""
...
SESSION_DURATION_SECONDS = 60  # 60 seconds for testing
        ...
        while self.running:
            try:
                ...
                if (current_clipboard != self.last_clipboard_content and
                    ...
                    clipboard_preview = (current_clipboard[:100] + '...'
                                       if len(current_clipboard) > 100
                                       else current_clipboard)
                    self.add_event('CLIPBOARD_COPY', clipboard_preview)
                ...
                try:
                    ...
                    if active_window and active_window.title:
                        ...
                        if current_window_title != self.last_window_title:
                            self.add_event('WINDOW_CHANGE',
                                         current_window_title)
                            self.last_window_title = current_window_title
                except Exception:
                    # Handle cases where no window is active
                    pass
...
""" + log_content
        ...
        ai_studio_url = f"https://aistudio.google.com/app/prompts/new?q={encoded_prompt}"
        return ai_studio_url
    ...
    def start_session(self, duration_seconds=None):
        ...
        print("Starting 60-second test session... Press Ctrl+C to stop early.")
